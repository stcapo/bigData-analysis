...
<div :style='{"width":"90%","padding":"30px 0px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.0)"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="归档单号" prop="guidangdanhao">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="评标情况" prop="pingbiaoqingkuang">
            <el-input v-model="ruleForm.pingbiaoqingkuang" 
                placeholder="评标情况" clearable readonly></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="归档文件" prop="guidangwenjian">
            <file-upload
            tip="点击上传归档文件"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="归档日期" prop="guidangriqi" >
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="归档说明" prop="guidangshuoming">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="归档说明"
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('guidangbaocun/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('guidangbaocun/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('guidangbaocun/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
      ...
      guidangwenjianUploadChange(fileUrls) {
          this.ruleForm.guidangwenjian = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
    }
  };
</script>
